...
export const DM_REPLIES_BY_CHAT = {
  ...
  grace: [
    ...
    "Found the most amazing ramen spot in the East Village. Reminds me of my time living in Tokyo — the attention to detail is on another level.",
    ...
    "I miss Tokyo sometimes — the convenience stores there have better design than most apps 😂 But NYC has its own magic.",
    ...
    "NYC design scene is the best in the world. Between the galleries, the architecture, and the street art — inspiration everywhere.",
    "Living in Tokyo for 3 years changed how I see everything. I brought that sensibility back to New York and it shapes all my work.",
    ...
    "Running the team retreat planning from Tokyo. 14 hour time difference but I'm making it work — nobody's getting left out.",
  ...
  thomas: [
    ...
    "Mon Dieu, zis croissant I 'ad zis morning was magnifique. Butter, layers, crunch — ze perfect start to ze day. 🥐",
    "I found a boulangerie in Miami zat makes croissants almost as good as Paris. Almost. Zey are still missing somezing.",
    "You cannot write good code wizout a proper breakfast. For me, zat means a croissant, un café, and zen I am ready.",
    "Ze French approach to engineering is like ze French approach to food — precision, elegance, and absolutely no shortcuts.",
    "I miss Paris sometimes. Ze architecture, ze café culture, ze smell of fresh bread in ze morning. But Miami 'as ze sunshine.",
    "Someone brought donuts to ze office. I appreciate ze gesture but... zey are not croissants. Zis is not ze same zing.",
    "SwiftUI reminds me of French cuisine — simple on ze surface, incredibly complex underneath. Zat is what makes it beautiful.",
  ],
  'joe-mini': [
