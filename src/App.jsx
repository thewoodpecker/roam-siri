    ...
    <div className="office-card">
      ...
      {showLabel && (
        <span className={`token-label ${fading ? 'fade-out' : ''}`}>
          {provider === 'both' ? (
            <img className="ai-icon ai-icon-combo" src="/icons/vibe-combo.svg" alt="" />
          ) : provider === 'codex' ? (
            <img className="ai-icon" src="/icons/codex-white.svg" alt="" />
          ) : (
            <img className="ai-icon" src="/icons/claude.svg" alt="" />
          )}
        </span>
      )}
...
const GLOW_COLORS = [
  ...
  { name: 'Codex', color: '#0000FF' },
];

function DevControls({ room, vibeCount, onVibeCountChange, provider, onProviderChange }) {
  return (
...
function FloorDevControls({ vibePercent, onVibePercentChange, provider, onProviderChange }) {
  return (
  ...
  return (
    <div className="war-room-view">
      ...
      <div className="floor-dev-controls">
        <DevControls room={room} vibeCount={vibeCount} onVibeCountChange={setVibeCount} glowColor={glowColor} onGlowColorChange={() => {}} provider={provider} onProviderChange={setProvider} />
      </div>
    </div>
  );
}
